...
class HomeController extends Controller
{
    ...
    {
        $fenlei=Fenlei5::all();
        $dangqian_fenlei = Fenlei5::where('id',$id)->first();
        $article = Article5::orderBy('id','desc')->where('fenlei_id','=',$id)->paginate(5);
        $lunbo = Article5::orderBy('id','desc')->where('fenlei_id',$id)->where('news_pic','<>','')->limit(5)->get();
    ...
    {
        $fenlei = Fenlei5::all();
        $content = Article5::where('id','=',$id)->first();
