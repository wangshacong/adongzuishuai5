 ...
 */
 (function($){
    ...
    $(".page-btn").one("click",function(){
    	var allPage = $(".allPage").text().replace(/,/g,"");
    	//console.log(allPage);
      var goPage = $(".page-go input").val() - 1; //跳转页数
      if(goPage > -1 && goPage < allPage){
				opts.current_page = goPage;
      	$("#Pagination").pagination(allPage,opts);
      	var channelId = $(".channelId").val().replace(/,/g,""); 
      	var channelName = $(".channelName").val().replace(/,/g,"");
      	location.href="http://www.szhk.com/news/newlist/"+channelName+"/"+channelId+"/"+$(".page-go input").val()+".htm";
      }else {
